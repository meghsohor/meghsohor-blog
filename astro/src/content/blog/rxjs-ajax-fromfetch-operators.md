...
image: '/images/blog/rxjs-ajax-fetchapi/rxjs-ajax-fetchapi.jpg'
description: "The ajax and fromFetch are two RxJS operators that can be used to get data from or send data to the servers."
tags:
- RxJS
- JavaScript
---
